...
<div class="w-full min-h-screen bg-cover bg-center relative" style="background-image: url('/sky.png');">
  <div class="absolute inset-0 bg-black/70 backdrop-blur-sm"></div>

  <div class="relative z-10 flex flex-col items-center justify-center min-h-screen p-8 text-center overflow-y-auto">
    <div class="max-w-4xl w-full">
      ...
      <div class="animate-in opacity-0 translate-y-8 transition-all duration-1000 mb-12">
        <button 
          on:click={shareGame}
