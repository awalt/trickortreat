        ...
        <div class="max-w-4xl w-full">
            ...
            >
                <h2 class="text-3xl font-bold text-orange-400 mb-2">
                    {TEXT.conclusion.your_time}
                </h2>
                <div class="text-6xl font-mono text-green-400 mb-2">
                    {finalTime}
                </div>
                <p class="text-gray-400">{TEXT.conclusion.time_subtitle}</p>
            </div>
                    ...
                    <div class="grid md:grid-cols-2 gap-8 items-center">
                        ...
                        <div class="order-1 md:order-2">
                            <h3 class="text-3xl font-bold text-blue-300 mb-4">
                                {TEXT.conclusion.promo_title}
                            </h3>
                            <p class="text-gray-300 text-lg mb-4">
                                {TEXT.conclusion.promo_desc}
                            </p>
                            <div
                            ...
                            >
                                <span
                                    ...
                                    >{TEXT.conclusion.promo_tag_1}</span
                                >
                                <span
                                    class="bg-blue-600/30 px-3 py-1 rounded-full text-blue-200 text-sm"
                                    >{TEXT.conclusion.promo_tag_2}</span
                                >
                                <span
                                    class="bg-blue-600/30 px-3 py-1 rounded-full text-blue-200 text-sm"
                                    >{TEXT.conclusion.promo_tag_3}</span
                                >
                            </div>
                            ...
                            >
                                <p class="text-orange-200 font-bold text-lg">
                                    {TEXT.conclusion.promo_special}
                                </p>
                                <p class="text-orange-100">
                                    {TEXT.conclusion.promo_use_code}
                                    <span
            ...
            >
                {#if nameSubmitted}
                    ...
                    >
                        <p class="text-green-400 font-bold">
                            {TEXT.conclusion.score_submitted}
                        </p>
                    </div>
                {:else if showNameInput}
                    ...
                    >
                        <h3 class="text-xl font-bold text-purple-400 mb-4">
                            {TEXT.conclusion.leaderboard_prompt}
                        </h3>
                        <form
                            name="leaderboard"
                            method="POST"
                        ...
                        >
                            ...
                            >
                                {isSubmitting
                                    ? TEXT.conclusion.leaderboard_submitting
                                    : TEXT.conclusion.leaderboard_submit}
                            </button>
                        </form>
                    </div>
                {:else}
                ...
                >
                    <h3 class="text-2xl font-bold text-yellow-400 mb-4">
                        {TEXT.conclusion.leaderboard_title}
                    </h3>
                    <div class="space-y-2">
            ...
            >
                ...
                >
                    {TEXT.conclusion.button_play_again}
                </button>
            </div>

            <div class="mt-12 pt-8 border-t border-gray-700/30 mb-3">
                <p class="text-gray-400 text-sm">
                    {TEXT.conclusion.footer_made_by_1}
                    <a
