...
>
  ...
  <div class="grid grid-cols-2 gap-2">
    ...
    <button on:click={resetTimer} class="bg-yellow-600 hover:bg-yellow-700 px-3 py-1 rounded text-sm">Reset Timer</button>
    <!-- NEW: The button to stop the timer -->
    <button on:click={stopTimer} class="bg-orange-600 hover:bg-orange-700 px-3 py-1 rounded text-sm">Stop Timer</button>
